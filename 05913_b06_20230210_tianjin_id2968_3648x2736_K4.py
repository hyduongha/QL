...
def main(name):
    ...
    excel_path = os.path.join("/content/drive/MyDrive/05913_b06_20230210_tianjin_id2968_3648x2736_K4/log"+numbers[0]+".xlsx")  # file Excel lưu
    excel_path_Vector = os.path.join("/content/drive/MyDrive/05913_b06_20230210_tianjin_id2968_3648x2736_K4/logVector"+numbers[0]+".xlsx")  # file Excel lưu
    excel_path_Eig = os.path.join("/content/drive/MyDrive/05913_b06_20230210_tianjin_id2968_3648x2736_K4/logEig"+numbers[0]+".xlsx")  # file Excel lưu
    output_path = "/content/drive/MyDrive/05913_b06_20230210_tianjin_id2968_3648x2736_K4/out"+numbers[0]
