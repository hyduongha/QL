...
def main(name):
    ...
    excel_path = os.path.join("/content/drive/MyDrive/06888_b06_20230210_tianjin_id3000_3000x4000_K4/log"+numbers[0]+".xlsx")  # file Excel lưu
    excel_path_Vector = os.path.join("/content/drive/MyDrive/06888_b06_20230210_tianjin_id3000_3000x4000_K4/logVector"+numbers[0]+".xlsx")  # file Excel lưu
    excel_path_Eig = os.path.join("/content/drive/MyDrive/06888_b06_20230210_tianjin_id3000_3000x4000_K4/logEig"+numbers[0]+".xlsx")  # file Excel lưu
    output_path = "/content/drive/MyDrive/06888_b06_20230210_tianjin_id3000_3000x4000_K4/out"+numbers[0]
