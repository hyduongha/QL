...
def main(name):
    ...
    input_path = "/content/drive/MyDrive/Test1/" + name
    excel_path = os.path.join("/content/drive/MyDrive/Test1/log"+numbers[0]+".xlsx")  # file Excel lưu
    excel_path_Vector = os.path.join("/content/drive/MyDrive/Test1/logVector"+numbers[0]+".xlsx")  # file Excel lưu
    excel_path_Eig = os.path.join("/content/drive/MyDrive/Test1/logEig"+numbers[0]+".xlsx")  # file Excel lưu
    output_path = "/content/drive/MyDrive/Test1/out"+numbers[0]
