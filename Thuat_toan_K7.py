...
def main(name):
    ...
    input_path = "/content/drive/MyDrive/TestK7/" + name
    excel_path = os.path.join("/content/drive/MyDrive/TestK7/log"+numbers[0]+".xlsx")  # file Excel lưu
    excel_path_Vector = os.path.join("/content/drive/MyDrive/TestK7/logVector"+numbers[0]+".xlsx")  # file Excel lưu
    excel_path_Eig = os.path.join("/content/drive/MyDrive/TestK7/logEig"+numbers[0]+".xlsx")  # file Excel lưu
    output_path = "/content/drive/MyDrive/TestK7/out"+numbers[0]
