...
def main(name):
    ...
    excel_path = os.path.join("/content/drive/MyDrive/15585_b08_20230224_yinchuan_id3131_3000x4000_K4/log"+numbers[0]+".xlsx")  # file Excel lưu
    excel_path_Vector = os.path.join("/content/drive/MyDrive/15585_b08_20230224_yinchuan_id3131_3000x4000_K4/logVector"+numbers[0]+".xlsx")  # file Excel lưu
    excel_path_Eig = os.path.join("/content/drive/MyDrive/15585_b08_20230224_yinchuan_id3131_3000x4000_K4/logEig"+numbers[0]+".xlsx")  # file Excel lưu
    output_path = "/content/drive/MyDrive/15585_b08_20230224_yinchuan_id3131_3000x4000_K4/out"+numbers[0]
