...
def main(name):
    ...
    excel_path = os.path.join("/content/drive/MyDrive/53633_b23_20230611_chengdu_id8047_3264x2448_K7/log"+numbers[0]+".xlsx")  # file Excel lưu
    excel_path_Vector = os.path.join("/content/drive/MyDrive/53633_b23_20230611_chengdu_id8047_3264x2448_K7/logVector"+numbers[0]+".xlsx")  # file Excel lưu
    excel_path_Eig = os.path.join("/content/drive/MyDrive/53633_b23_20230611_chengdu_id8047_3264x2448_K7/logEig"+numbers[0]+".xlsx")  # file Excel lưu
    output_path = "/content/drive/MyDrive/53633_b23_20230611_chengdu_id8047_3264x2448_K7/out"+numbers[0]
