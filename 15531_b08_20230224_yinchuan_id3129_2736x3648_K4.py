...
def main(name):
    ...
    excel_path_Vector = os.path.join("/content/drive/MyDrive/15531_b08_20230224_yinchuan_id3129_2736x3648_K4/logVector"+numbers[0]+".xlsx")  # file Excel lưu
    excel_path_Eig = os.path.join("/content/drive/MyDrive/15531_b08_20230224_yinchuan_id3129_2736x3648_K4/logEig"+numbers[0]+".xlsx")  # file Excel lưu
