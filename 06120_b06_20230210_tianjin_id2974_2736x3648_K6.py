...
def main(name):
    ...
    excel_path = os.path.join("/content/drive/MyDrive/06120_b06_20230210_tianjin_id2974_2736x3648_K6/log"+numbers[0]+".xlsx")  # file Excel lưu
    excel_path_Vector = os.path.join("/content/drive/MyDrive/06120_b06_20230210_tianjin_id2974_2736x3648_K6/logVector"+numbers[0]+".xlsx")  # file Excel lưu
    excel_path_Eig = os.path.join("/content/drive/MyDrive/06120_b06_20230210_tianjin_id2974_2736x3648_K6/logEig"+numbers[0]+".xlsx")  # file Excel lưu
    output_path = "/content/drive/MyDrive/06120_b06_20230210_tianjin_id2974_2736x3648_K6/out"+numbers[0]
