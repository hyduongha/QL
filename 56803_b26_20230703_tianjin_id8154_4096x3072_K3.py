...
def main(name):
    ...
    excel_path = os.path.join("/content/drive/MyDrive/56803_b26_20230703_tianjin_id8154_4096x3072_K3/log"+numbers[0]+".xlsx")  # file Excel lưu
    excel_path_Vector = os.path.join("/content/drive/MyDrive/56803_b26_20230703_tianjin_id8154_4096x3072_K3/logVector"+numbers[0]+".xlsx")  # file Excel lưu
    excel_path_Eig = os.path.join("/content/drive/MyDrive/56803_b26_20230703_tianjin_id8154_4096x3072_K3/logEig"+numbers[0]+".xlsx")  # file Excel lưu
    output_path = "/content/drive/MyDrive/56803_b26_20230703_tianjin_id8154_4096x3072_K3/out"+numbers[0]
