...
def main(name):
    ...
    excel_path = os.path.join("/content/drive/MyDrive/25006_b09_20230303_yinchuan_id5924_2736x3648_K5/log"+numbers[0]+".xlsx")  # file Excel lưu
    excel_path_Vector = os.path.join("/content/drive/MyDrive/25006_b09_20230303_yinchuan_id5924_2736x3648_K5/logVector"+numbers[0]+".xlsx")  # file Excel lưu
    excel_path_Eig = os.path.join("/content/drive/MyDrive/25006_b09_20230303_yinchuan_id5924_2736x3648_K5/logEig"+numbers[0]+".xlsx")  # file Excel lưu
    output_path = "/content/drive/MyDrive/25006_b09_20230303_yinchuan_id5924_2736x3648_K5/out"+numbers[0]
