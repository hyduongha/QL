...
def main(name):
    ...
    excel_path = os.path.join("/content/drive/MyDrive/24778_b09_20230303_yinchuan_id5916_3000x4000_K3/log"+numbers[0]+".xlsx")  # file Excel lưu
    excel_path_Vector = os.path.join("/content/drive/MyDrive/24778_b09_20230303_yinchuan_id5916_3000x4000_K3/logVector"+numbers[0]+".xlsx")  # file Excel lưu
    excel_path_Eig = os.path.join("/content/drive/MyDrive/24778_b09_20230303_yinchuan_id5916_3000x4000_K3/logEig"+numbers[0]+".xlsx")  # file Excel lưu
    output_path = "/content/drive/MyDrive/24778_b09_20230303_yinchuan_id5916_3000x4000_K3/out"+numbers[0]
